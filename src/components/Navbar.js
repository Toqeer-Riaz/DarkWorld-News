        ...
        <div>
            <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>,
                <div className="container-fluid">
                    <Link className="navbar-brand" to="/getstart">DW-News</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item"><Link className={`nav-link ${location.pathname === "/general" ? "active" : ""}`} aria-current="page" to="/getstart">General</Link></li>
                        ...
                        <button onClick={logout} className=" mx-3 btn btn-danger">Logout</button>
